...
return [
    ...
    'views' => [
        ['region' => 'header', 'template' => 'me/header', 'data' => [
                'siteTitle' => "Marcus + phpmvc = sant",
                'siteTagline' => "", //Jag och phpmvc i symbios",
            ], 'sort' => -1],
    ...
    'data' => [
        ...
        // Stylesheets
        'stylesheets' => ['css/style_me.css', 'css/navbar_me2.css', '//maxcdn.bootstrapcdn.com/font-awesome/4.2.0/css/font-awesome.min.css'],
        ...
        'javascript_include' => ['js/me_fonts.js'],
